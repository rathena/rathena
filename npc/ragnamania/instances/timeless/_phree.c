// --------------------------------------------------------------------------
yuno_in03,33,27,1	script	Phreeoni#phree	111,{
// --------------------------------------------------------------------------
callfunc("F_CheckParty",200,255,3,5,.quest_id);
callfunc "F_InstanceEnter",.quest_id,.instance_name$,strnpcinfo(2);
callfunc "F_CreateInstance",.quest_id,.instance_name$,200,255,3,5,strnpcinfo(2),instance_info(.instance_name$,IIT_ENTER_MAP),1159;
end;
OnInit:
	.instance_name$	= "Phreeoni [Normal]";
	.quest_id		= 69503;
	end;
}
// --------------------------------------------------------------------------
moc_fild17,1,1,3	script	Normal Chest#phree	1324,{
// --------------------------------------------------------------------------
