// --------------------------------------------------------------------------
yuno_in03,39,122,1	script	Maya#maya	111,{
// --------------------------------------------------------------------------
callfunc("F_CheckParty",200,255,3,5,.quest_id);
callfunc "F_InstanceEnter",.quest_id,.instance_name$,strnpcinfo(2);
callfunc "F_CreateInstance",.quest_id,.instance_name$,200,255,3,5,strnpcinfo(2),instance_info(.instance_name$,IIT_ENTER_MAP),1147;
end;
OnInit:
	.instance_name$	= "Maya [Normal]";
	.quest_id		= 69519;
	end;
}
// --------------------------------------------------------------------------
anthell02,1,1,3	script	Normal Chest#maya	1324,{
// --------------------------------------------------------------------------
