// --------------------------------------------------------------------------
yuno_in03,19,120,1	script	Dark Lord#dark	111,{
// --------------------------------------------------------------------------
callfunc("F_CheckParty",200,255,3,5,.quest_id);
callfunc "F_InstanceEnter",.quest_id,.instance_name$,strnpcinfo(2);
callfunc "F_CreateInstance",.quest_id,.instance_name$,200,255,3,5,strnpcinfo(2),instance_info(.instance_name$,IIT_ENTER_MAP),1272;
end;
OnInit:
	.instance_name$	= "Dark Lord [Normal]";
	.quest_id		= 69512;
	end;
}
// --------------------------------------------------------------------------
gl_chyard,1,1,3	script	Normal Chest#dark	1324,{
// --------------------------------------------------------------------------
