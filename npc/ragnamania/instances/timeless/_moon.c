// --------------------------------------------------------------------------
yuno_in03,35,122,1	script	Moonlight#moon	111,{
// --------------------------------------------------------------------------
callfunc("F_CheckParty",200,255,3,5,.quest_id);
callfunc "F_InstanceEnter",.quest_id,.instance_name$,strnpcinfo(2);
callfunc "F_CreateInstance",.quest_id,.instance_name$,200,255,3,5,strnpcinfo(2),instance_info(.instance_name$,IIT_ENTER_MAP),1150;
end;
OnInit:
	.instance_name$	= "Moonlight [Normal]";
	.quest_id		= 69518;
	end;
}
// --------------------------------------------------------------------------
pay_dun04,1,1,3	script	Normal Chest#moon	1324,{
// --------------------------------------------------------------------------
