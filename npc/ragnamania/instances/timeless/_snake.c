// --------------------------------------------------------------------------
yuno_in03,19,21,1	script	Snake Lord#snake	111,{
// --------------------------------------------------------------------------
callfunc("F_CheckParty",200,255,3,5,.quest_id);
callfunc "F_InstanceEnter",.quest_id,.instance_name$,strnpcinfo(2);
callfunc "F_CreateInstance",.quest_id,.instance_name$,200,255,3,5,strnpcinfo(2),instance_info(.instance_name$,IIT_ENTER_MAP),1418;
end;
OnInit:
	.instance_name$	= "Snake Lord [Normal]";
	.quest_id		= 69504;
	end;
}
// --------------------------------------------------------------------------
gon_dun03,1,1,3	script	Normal Chest#snake	1324,{
// --------------------------------------------------------------------------
