// --------------------------------------------------------------------------
yuno_in03,31,122,1	script	Tao Gunka#gunka	111,{
// --------------------------------------------------------------------------
callfunc("F_CheckParty",200,255,3,5,.quest_id);
callfunc "F_InstanceEnter",.quest_id,.instance_name$,strnpcinfo(2);
callfunc "F_CreateInstance",.quest_id,.instance_name$,200,255,3,5,strnpcinfo(2),instance_info(.instance_name$,IIT_ENTER_MAP),1583;
end;
OnInit:
	.instance_name$	= "Tao Gunka [Normal]";
	.quest_id		= 69516;
	end;
}
// --------------------------------------------------------------------------
beach_dun,1,1,3	script	Normal Chest#gunka	1324,{
// --------------------------------------------------------------------------
