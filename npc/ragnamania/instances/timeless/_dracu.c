// --------------------------------------------------------------------------
yuno_in03,45,116,1	script	Dracula#dracu	111,{
// --------------------------------------------------------------------------
callfunc("F_CheckParty",200,255,3,5,.quest_id);
callfunc "F_InstanceEnter",.quest_id,.instance_name$,strnpcinfo(2);
callfunc "F_CreateInstance",.quest_id,.instance_name$,200,255,3,5,strnpcinfo(2),instance_info(.instance_name$,IIT_ENTER_MAP),1389;
end;
OnInit:
	.instance_name$	= "Dracula [Normal]";
	.quest_id		= 69514;
	end;
}
// --------------------------------------------------------------------------
gef_dun01,1,1,3	script	Normal Chest#dracu	1324,{
// --------------------------------------------------------------------------
