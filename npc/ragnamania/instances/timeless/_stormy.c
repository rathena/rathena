// --------------------------------------------------------------------------
yuno_in03,37,44,3	script	Stormy Knight#stormy	111,{
// --------------------------------------------------------------------------
callfunc("F_CheckParty",200,255,3,5,.quest_id);
callfunc "F_InstanceEnter",.quest_id,.instance_name$,strnpcinfo(2);
callfunc "F_CreateInstance",.quest_id,.instance_name$,200,255,3,5,strnpcinfo(2),instance_info(.instance_name$,IIT_ENTER_MAP),1251;
end;
OnInit:
	.instance_name$	= "Stormy Knight [Normal]";
	.quest_id		= 69509;
	end;
}
// --------------------------------------------------------------------------
xmas_dun02,1,1,3	script	Normal Chest#stormy	1324,{
// --------------------------------------------------------------------------
