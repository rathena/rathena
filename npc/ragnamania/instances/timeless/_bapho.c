// --------------------------------------------------------------------------
yuno_in03,20,94,1	script	Baphomet#bapho	111,{
// --------------------------------------------------------------------------
callfunc("F_CheckParty",200,255,3,5,.quest_id);
callfunc "F_InstanceEnter",.quest_id,.instance_name$,strnpcinfo(2);
callfunc "F_CreateInstance",.quest_id,.instance_name$,200,255,3,5,strnpcinfo(2),instance_info(.instance_name$,IIT_ENTER_MAP),1039;
end;
OnInit:
	.instance_name$	= "Baphomet [Normal]";
	.quest_id		= 69513;
	end;
}
// --------------------------------------------------------------------------
prt_maze02,1,1,3	script	Normal Chest#bapho	1324,{
// --------------------------------------------------------------------------
