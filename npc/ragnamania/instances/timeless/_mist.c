// --------------------------------------------------------------------------
yuno_in03,33,33,1	script	Mistress#mist	111,{
// --------------------------------------------------------------------------
callfunc("F_CheckParty",200,255,3,5,.quest_id);
callfunc "F_InstanceEnter",.quest_id,.instance_name$,strnpcinfo(2);
callfunc "F_CreateInstance",.quest_id,.instance_name$,200,255,3,5,strnpcinfo(2),instance_info(.instance_name$,IIT_ENTER_MAP),1059;
end;
OnInit:
	.instance_name$	= "Mistress [Normal]";
	.quest_id		= 69502;
	end;
}
// --------------------------------------------------------------------------
mjolnir_04,1,1,3	script	Normal Chest#mist	1324,{
// --------------------------------------------------------------------------
