...
alberta,88,193,5	script	Sunglasses Trader	73,{
	...
	if(SG_QUEST1 == 1) {
		...
		next;
		mes "[Sunglasses Trader]";
		mes "Go see Maseph. She is somewhere north of Morocc.";
		close; }
	...
	mes " - ^00008830 1Carat Diamond^000000";
	mes " - ^000088200 Feathers^000000";
	mes " - ^000088500000z^000000";
	next;
	if(select("Alright, here.:That's too much!")==2) {
		...
		close; }
	mes "[Sunglasses Trader]";
	if (countitem(730) < 30 || countitem(949) < 200 || Zeny < 500000) {
	...
	next;
	mes "[Sunglasses Trader]";
	mes "Look for someone named Maseph somewhere north of Morocc.";
...
moc_fild07,334,186,5	script	Maseph	702,{
	...
	if(select("Yes:No, sorry to bother you.")==2) {
		...
		close; }
	mes "[Maseph]";
	mes "To make one, I will need one pair of ^000088Sunglasses^000000 and 300000z.";
	next;
