...
prt_in,137,23,3	script	SlotMachine::1slot	563,{
	if( getgmlevel() == 99 ) {
...
mes "Remember, use Poring Coin for play !!!!";		
...
setarray .ssm_prize[0],125,6542,1;
setarray .tsm_prize[0],450,7539,30;
...
.payment = 2;
// [0] = Zeny, [1] = Item ID, [2] = Item Amount;
setarray .ssm_payment[0],1000000,7539,1; // Single Slot Machine Payment Price
