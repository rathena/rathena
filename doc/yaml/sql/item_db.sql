...
CREATE TABLE `item_db` (
  ...
  `str` smallint(4) unsigned DEFAULT NULL,
  `agi` smallint(4) unsigned DEFAULT NULL,
  `vit` smallint(4) unsigned DEFAULT NULL,
  `int` smallint(4) unsigned DEFAULT NULL,
  `dex` smallint(4) unsigned DEFAULT NULL,
  `luk` smallint(4) unsigned DEFAULT NULL,
  `max_hp` int(11) unsigned DEFAULT NULL,
  `max_sp` int(11) unsigned DEFAULT NULL,
