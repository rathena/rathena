...
CREATE TABLE `item_db` (
  ...
  `magic_defense` smallint(5) unsigned DEFAULT NULL,
  `str` smallint(4) unsigned NOT NULL DEFAULT NULL,
  `agi` smallint(4) unsigned NOT NULL DEFAULT NULL,
  `vit` smallint(4) unsigned NOT NULL DEFAULT NULL,
  `int` smallint(4) unsigned NOT NULL DEFAULT NULL,
  `dex` smallint(4) unsigned NOT NULL DEFAULT NULL,
  `luk` smallint(4) unsigned NOT NULL DEFAULT NULL,
  `max_hp` int(11) unsigned NOT NULL DEFAULT NULL,
  `max_sp` int(11) unsigned NOT NULL DEFAULT NULL,
  ...
  `weapon_element` varchar(24) DEFAULT NULL,
  ...
  `indestructible` tinyint(1) unsigned DEFAULT NULL,
