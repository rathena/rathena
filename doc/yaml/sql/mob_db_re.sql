...
CREATE TABLE `mob_db_re` (
  ...
  `racegroup_illusion_teddy_bear` tinyint(1) unsigned DEFAULT NULL,
  `racegroup_illusion_twins` tinyint(1) unsigned DEFAULT NULL,
  `racegroup_illusion_underwater` tinyint(1) unsigned DEFAULT NULL,
  `racegroup_illusion_labyrinth` tinyint(1) unsigned DEFAULT NULL,
