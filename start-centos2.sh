#!/bin/sh
#
# athena    Init script for rAthena
#
# chkconfig: 0346 99 01
# processname: athena
# pidfile: /home/eraser69/rathena/rathena_process.pid
# description: Various functions to start and stop rAthena.
#
#source var/function
ATHENAPATH=/home/eraser69/rathena/
L_SRV=$ATHENAPATH/login-server
C_SRV=$ATHENAPATH/char-server
M_SRV=$ATHENAPATH/map-server
INST_PATH=/opt
PKG=rathena
...
PATH="/home/eraser69/rathena":$PATH
LOG_DIR=$ATHENAPATH/log

print_start() {
        echo $! > /home/eraser69/rathena/rathena_process.pid
        #    more << EOF
