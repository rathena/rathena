...
mysql -u $DB_ROOT $DB_NAME < sql-files/mob_drop.sql || aborterror "Unable to import pre-renewal monster table."
mysql -u $DB_ROOT $DB_NAME < sql-files/mob_drop2.sql || aborterror "Unable to import pre-renewal monster 2 table."
...
mysql -u $DB_ROOT $DB_NAME < sql-files/mob_drop_re.sql || aborterror "Unable to import pre-renewal monster table."
mysql -u $DB_ROOT $DB_NAME < sql-files/mob_drop2_re.sql || aborterror "Unable to import pre-renewal monster 2 table."
