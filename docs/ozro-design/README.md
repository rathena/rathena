...
Las secciones **Comentarios** y **Notas de sesión** son para anotar feedback al jugar.
...
- **2026-07:** Crimson Weapons — en Hercules estaban rotas; en rAthena ya se pueden conseguir. Revisar si reactivar la quest custom o usar la oficial.

## Notas de sesión

<!-- Pegar feedback después de cada período de juego (vacaciones, etc.) -->
