...
REPLACE INTO `item_db2` (`id`,`name_aegis`,`name_english`,`type`,`price_buy`,`weight`,`defense`,`equip_locations`,`view`,`script`) VALUES (5811,'Santa_Beard','Santa Beard','Armor',20,100,5,'Head_Low:true',25,'bonus2 bSubRace,RC_Brute,5; bonus2 bSubRace,RC_Player_Doram,5;');
