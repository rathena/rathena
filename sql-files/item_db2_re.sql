...
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`price_buy`,`weight`,`defense`,`equip_locations`,`view`,`script`) VALUES (5811,'Santa_Beard','Santa Beard','Armor',20,100,5,'Head_Low:true',25,'bonus2 bSubRace,RC_Brute,5; bonus2 bSubRace,RC_Player_Doram,5;');
...
#=============================================================
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`price_buy`,`weight`,`equip_jobs`,`equip_locations`,`refineable`,`equip_script`,`unequip_script`) VALUES (2338,'Wedding_Dress','Wedding Dress','Armor',43000,500,'All:true|Novice:false|SuperNovice:false','Armor:true',true,'sc_start SC_WEDDING,INFINITE_TICK,0;','sc_end SC_WEDDING;');
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`price_buy`,`weight`,`equip_jobs`,`equip_genders`,`equip_locations`,`refineable`,`equip_script`,`unequip_script`) VALUES (7170,'Tuxedo','Tuxedo','Armor',43000,10,'All:true|Novice:false|SuperNovice:false','Male','Armor:true',true,'sc_start SC_WEDDING,INFINITE_TICK,0;','sc_end SC_WEDDING;');
