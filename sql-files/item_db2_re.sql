...
CREATE TABLE `item_db2_re` (
  ...
  `magic_attack` smallint unsigned DEFAULT NULL,
  ...
  `job_kagerouoboro` tinyint unsigned DEFAULT NULL,
  ...
  `job_rebellion` tinyint unsigned DEFAULT NULL,
  ...
  `job_spirit_handler` tinyint unsigned DEFAULT NULL,
  `job_stargladiator` tinyint unsigned DEFAULT NULL,
  `job_summoner` tinyint unsigned DEFAULT NULL,
  ...
  `class_third` tinyint unsigned DEFAULT NULL,
  `class_third_upper` tinyint unsigned DEFAULT NULL,
  `class_third_baby` tinyint unsigned DEFAULT NULL,
  `class_fourth` tinyint unsigned DEFAULT NULL,
  ...
  `gradable` tinyint unsigned DEFAULT NULL,
