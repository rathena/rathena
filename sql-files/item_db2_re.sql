...
# THQ Quest Items
#=============================================================
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`price_sell`,`weight`,`equip_jobs`) VALUES (7950,'THG_Membership','THG Membership','Etc',10,10,'All:true');
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`price_sell`,`weight`,`equip_jobs`) VALUES (7951,'Token_Bag','Token Bag','Etc',10,10,'All:true');
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`price_sell`,`weight`,`equip_jobs`) VALUES (1998,'Jeramiah\'s_Jur','Jeramiah\'s Jur','Etc',10,10,'All:true');
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`price_sell`,`weight`,`equip_jobs`) VALUES (1999,'Zed\'s_Staff','Zed\'s Staff','Etc',10,10,'All:true');
...
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`price_buy`,`equip_jobs`) VALUES (7946,'Gold_Ring_Of_Valentine','Gold Ring Of Valentine','Etc',10,'All:true');
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`price_buy`,`equip_jobs`) VALUES (7947,'Silver_Ring_Of_Valentine','Silver Ring Of Valentine','Etc',10,'All:true');
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`price_buy`,`weight`,`equip_jobs`) VALUES (7948,'Box','Box','Etc',10,10,'All:true');
...
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`equip_jobs`) VALUES (6298,'Crushed_Pumpkin','Crushed Pumpkin','Etc','All:true');
REPLACE INTO `item_db2_re` (`id`,`name_aegis`,`name_english`,`type`,`equip_jobs`) VALUES (6299,'Worn_Fabric','Worn Fabric','Etc','All:true');
