...
CREATE TABLE `mob_db2_re` (
  ...
  `resistance` smallint unsigned DEFAULT NULL,
  `magic_resistance` smallint unsigned DEFAULT NULL,
  ...
  `racegroup_ep172alpha` tinyint unsigned DEFAULT NULL,
  `racegroup_ep172beta` tinyint unsigned DEFAULT NULL,
  `racegroup_ep172bath` tinyint unsigned DEFAULT NULL,
  `racegroup_illusion_turtle` tinyint unsigned DEFAULT NULL,
  `racegroup_rachel_sanctuary` tinyint unsigned DEFAULT NULL,
  `racegroup_illusion_luanda` tinyint unsigned DEFAULT NULL,
  `racegroup_illusion_frozen` tinyint unsigned DEFAULT NULL,
  `racegroup_illusion_moonlight` tinyint unsigned DEFAULT NULL,
  `racegroup_ep16_def` tinyint unsigned DEFAULT NULL,
