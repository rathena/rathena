...
DELETE FROM `skill` USING `skill`, `char` WHERE (`char`.class == 4190 OR `char`.class == 4191) AND `skill`.id = 119;
...
DELETE FROM `skill` USING `skill`, `char` WHERE (`char`.class == 4190 OR `char`.class == 4191) AND `skill`.id = 120;
...
DELETE FROM `skill` USING `skill`, `char` WHERE (`char`.class == 4190 OR `char`.class == 4191) AND `skill`.id = 121;
