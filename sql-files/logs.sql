...
CREATE TABLE IF NOT EXISTS `atcommandlog` (
  ...
  `atcommand_date` datetime NOT NULL default '1000-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `branchlog` (
  ...
  `branch_date` datetime NOT NULL default '1000-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `mvplog` (
  ...
  `mvp_date` datetime NOT NULL default '1000-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `npclog` (
  ...
  `npc_date` datetime NOT NULL default '1000-01-01 00:00:00',
  `account_id` int(11) unsigned NOT NULL default '0',
  `char_id` int(11) unsigned NOT NULL default '0',
  `char_name` varchar(25) NOT NULL default '',
  `map` varchar(11) NOT NULL default '',
