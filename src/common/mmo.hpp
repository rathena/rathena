...
#define MAX_CART 250 ///Maximum item in cart
...
#define MAX_STORAGE 650 ///Max number of storage slots a player can have
#define MAX_GUILD_STORAGE 650 ///Max number of storage slots a guild
