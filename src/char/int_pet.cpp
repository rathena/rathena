...
int mapif_create_pet(int fd, uint32 account_id, uint32 char_id, short pet_class, short pet_lv, uint32 pet_egg_id, uint32 pet_equip, short intimate, short hungry, char rename_flag, char incubate, char *pet_name)
{
