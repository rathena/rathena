...
struct Battle_Config
{
	...
	int gvg_te_short_damage_rate;
	int gvg_te_long_damage_rate;
	int gvg_te_weapon_damage_rate;
	int gvg_te_magic_damage_rate;
	int gvg_te_misc_damage_rate;
	...
	int pvp_te_short_damage_rate;
	int pvp_te_long_damage_rate;
	int pvp_te_weapon_damage_rate;
	int pvp_te_magic_damage_rate;
	int pvp_te_misc_damage_rate;
	int pvp_te_flee_penalty;
