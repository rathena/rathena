...
enum _sp {
	...
	SP_IGNORE_DEF_CLASS, SP_IGNORE_MDEF_RACE_RATE, SP_IGNORE_DEF_RACE_RATE, SP_DEF_RATIO_ATK_CLASS, //2062-2065
	SP_ADDCLASS, SP_SUBCLASS, SP_MAGIC_ADDCLASS, SP_WEAPON_COMA_CLASS, SP_CRITICAL_ADDCLASS, SP_EXP_ADDCLASS, //2066-2071
	SP_SP_GAIN_CLASS, SP_HP_DRAIN_VALUE_CLASS, SP_SP_DRAIN_VALUE_CLASS, SP_IGNORE_MDEF_CLASS_RATE, //2072-2075
	SP_IGNORE_DEF_CLASS_RATE, SP_SP_GAIN_CLASS_ATTACK, SP_HP_GAIN_CLASS_ATTACK //2076-2078
};
