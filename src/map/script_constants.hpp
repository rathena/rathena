...
#define SCRIPT_CONSTANTS_HPP
	...
	// Custom Entries for Mild Wind skill to show correct icons when using client patch "Use icons from stateiconimginfo.lub" [llchrisll]
	export_constant(SC_FIREWEAPON_TK);
	export_constant(SC_WATERWEAPON_TK);
	export_constant(SC_WINDWEAPON_TK);
	export_constant(SC_EARTHWEAPON_TK);
	export_constant(SC_HOLYWEAPON_TK);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	// Custom Entries for Mild Wind skill to show correct icons when using client patch "Use icons from stateiconimginfo.lub" [llchrisll]
	export_constant(EFST_PROPERTYFIRE_TK);
	export_constant(EFST_PROPERTYWATER_TK);
	export_constant(EFST_PROPERTYWIND_TK);
	export_constant(EFST_PROPERTYGROUND_TK);
	export_constant(EFST_PROPERTYHOLY_TK);
