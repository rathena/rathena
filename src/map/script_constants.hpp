...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant_npc(JT_EP21_NPC_SERPENT);
	export_constant_npc(JT_EP21_NPC_TAN);
	export_constant_npc(JT_EP21_NPC_NADOYO);
	export_constant_npc(JT_EP21_NPC_REINHARDT);
	export_constant_npc(JT_EP21_NPC_WILHELM);
	export_constant_npc(JT_EP21_NPC_MARISTELLA);
	export_constant_npc(JT_EP21_NPC_YOHAN);
	export_constant_npc(JT_EP21_NPC_RICHARD);
	export_constant_npc(JT_EP21_NPC_EIBA);
	export_constant_npc(JT_EP21_NPC_GUNTER);
	export_constant_npc(JT_EP21_NPC_IVAN);
	export_constant_npc(JT_EP21_NPC_GALAXIA);
	export_constant_npc(JT_EP21_NPC_SEAWIND);
	export_constant_npc(JT_EP21_SCALLEG);
	export_constant_npc(JT_EP21_VELELLING);
	export_constant_npc(JT_EP21_LETTERSTER);
	export_constant_npc(JT_EP21_ROCKSTRIKER);
	export_constant_npc(JT_EP21_ICESEAHORSE);
	export_constant_npc(JT_EP21_SKIPSKIPPER);
	export_constant_npc(JT_EP21_CLIOLIMA);
	export_constant_npc(JT_EP21_YORKER_A);
	export_constant_npc(JT_EP21_YORKER_B);
	export_constant_npc(JT_EP21_YOSTER_A);
	export_constant_npc(JT_EP21_YOSTER_B);
	export_constant_npc(JT_EP21_YOSTER_C);
	export_constant_npc(JT_EP21_YOSTER_D);
	export_constant_npc(JT_EP21_YOSTER_E);
	export_constant_npc(JT_EP21_YORMI_A);
	export_constant_npc(JT_EP21_YORMI_B);
	export_constant_npc(JT_EP21_YORDOS_A);
	export_constant_npc(JT_EP21_YORDOS_B);
	export_constant_npc(JT_EP21_YORDOS_C);
	export_constant_npc(JT_EP21_YOSCOPUS_A);
	export_constant_npc(JT_EP21_YOSCOPUS_B);
	export_constant_npc(JT_EP21_YORTUS_A);
	export_constant_npc(JT_EP21_YORTUS_B);
	export_constant_npc(JT_EP21_ICEHORN);
	export_constant_npc(JT_EP21_B_YORTUS_A);
	export_constant_npc(JT_EP21_B_YORTUS_B);
	export_constant_npc(JT_G_EP21_ICESEAHORSE);
	export_constant_npc(JT_G_EP21_YORDOS_A);
	export_constant_npc(JT_G_EP21_YORDOS_B);
	export_constant_npc(JT_G_EP21_YORDOS_C);
	export_constant_npc(JT_EP21_MD_SAILOR);
	export_constant_npc(JT_EP21_MD_CAPTAIN);
	export_constant_npc(JT_EP21_YOR_TAN);
	export_constant_npc(JT_EP21_MD_CAPTAIN_B);
	export_constant_npc(JT_EP21_YOR_TAN_B);
	export_constant_npc(JT_EP21_MD_BOX1);
	export_constant_npc(JT_EV_NPC_VACATION_POPE);
	export_constant_npc(JT_E_WATER_M_RING);
	export_constant_npc(JT_CLB_SS_FC);
	export_constant_npc(JT_CLB_SS_TZ);
	export_constant_npc(JT_VIOLEN);
	export_constant_npc(JT_SPIDING);
	export_constant_npc(JT_CP_SPIDING);
	export_constant_npc(JT_GARLING);
	export_constant_npc(JT_CP_GARLING);
	export_constant_npc(JT_JACKONETTE);
	export_constant_npc(JT_CP_JACKONETTE);
	export_constant_npc(JT_LIAMETTE);
	export_constant_npc(JT_CP_LIAMETTE);
	export_constant_npc(JT_G_LIAMETTE);
	export_constant_npc(JT_NIGHTMARE_PIAMETTE);
	export_constant_npc(JT_MEDJED);
	export_constant_npc(JT_CP_MEDJED);
	export_constant_npc(JT_MEDJAY);
	export_constant_npc(JT_CP_MEDJAY);
	export_constant_npc(JT_OPHOIS);
	export_constant_npc(JT_CP_OPHOIS);
	export_constant_npc(JT_HEKA);
	export_constant_npc(JT_CP_HEKA);
	export_constant_npc(JT_G_OPHOIS);
	export_constant_npc(JT_GUIDE_OF_DEAD);
	export_constant_npc(JT_MISTRESS3);
	export_constant_npc(JT_GIANT_HONET2);
	export_constant_npc(JT_E_SMART_ANDRE);
	export_constant_npc(JT_E_RE_PINE);
	...
	export_constant_npc(JT_EVT_E_SIROMA);
	export_constant_npc(JT_EVT_E_MYSTCASE);
	export_constant_npc(JT_EVT_E_X_PORING);
	...
	export_constant_npc(JT_MD_C_ZOMBI);
	...
	export_constant_npc(JT_20TH_GATE_GREEN);
	export_constant_npc(JT_20TH_GATE_PURPLE);
	export_constant_npc(JT_20TH_GATE_RED);
	export_constant_npc(JT_20TH_CRYSTAL_S);
	export_constant_npc(JT_20TH_CRYSTAL_M);
	export_constant_npc(JT_20TH_CRYSTAL_L);
	export_constant_npc(JT_CWHITEKNIGHT);
	export_constant_npc(JT_KNIGHT_OF_ABYSS2);
	export_constant_npc(JT_GH_WHITEKNIGHT);
	export_constant_npc(JT_EDDGA3);
	export_constant_npc(JT_20TH_GATE_GREEN_M);
	export_constant_npc(JT_20TH_GATE_GREEN_S);
	export_constant_npc(JT_20TH_GATE_PURPLE_M);
	export_constant_npc(JT_20TH_GATE_PURPLE_S);
	export_constant_npc(JT_20TH_GATE_RED_M);
	export_constant_npc(JT_20TH_GATE_RED_S);
	export_constant_npc(JT_VH_BONE_DETALE);
	export_constant_npc(JT_VH_INGRID);
	export_constant_npc(JT_VH_GRAN_PAPILIA);
	export_constant_npc(JT_VH_PITAYA_BOSS);
	export_constant_npc(JT_VH_SILVA_PAPILIA);
	export_constant_npc(JT_VH_SWEETY);
	export_constant_npc(JT_VH_AMDARAIS);
	export_constant_npc(JT_VH_HEMEL);
	export_constant_npc(JT_VH_ABYSMAL_WITCH);
	export_constant_npc(JT_VH_DEATH_WITCH);
	export_constant_npc(JT_VH_R001_BESTIA);
	export_constant_npc(JT_VH_SAKRAY);
	export_constant_npc(JT_VH_TIARA);
	export_constant_npc(JT_VH_AIRBOAT_BOSS);
	export_constant_npc(JT_VH_BETELGEUSE);
	export_constant_npc(JT_VH_BURNING_FANG);
	export_constant_npc(JT_VH_FREYJA);
	export_constant_npc(JT_VH_SCHULANG);
	export_constant_npc(JT_VH_LIMACINA_BOSS);
	export_constant_npc(JT_VH_JUNCEA);
	export_constant_npc(JT_VH_RKNT);
	export_constant_npc(JT_VH_RYGD);
	export_constant_npc(JT_VH_ACBS);
	export_constant_npc(JT_VH_RNGR);
	export_constant_npc(JT_VH_GX);
	export_constant_npc(JT_VH_SC);
	export_constant_npc(JT_VH_WR);
	export_constant_npc(JT_E_PORING_20);
	export_constant_npc(JT_EP19_MD_BOX1);
	export_constant_npc(JT_EP19_MD_BOX2);
	export_constant_npc(JT_HEROS_DRAGON_1);
	export_constant_npc(JT_HEROS_DRAGON_2);
	export_constant_npc(JT_HEROS_DRAGON_3);
	export_constant_npc(JT_HEROS_DRAGON_4);
	export_constant_npc(JT_G_MASTERING);
	export_constant_npc(JT_G_CRAB);
	export_constant_npc(JT_G_SHELLFISH);
	export_constant_npc(JT_VR_MD_SWORDMAN);
	export_constant_npc(JT_VR_MARLBRON);
	export_constant_npc(JT_HEROS_IN_ORB_1);
	export_constant_npc(JT_HEROS_IN_ORB_2);
	export_constant_npc(JT_HEROS_IN_ORB_3);
	export_constant_npc(JT_HEROS_IN_ORB_4);
	export_constant_npc(JT_VR_MD_DEVIL);
	export_constant_npc(JT_HEROS_OUT_ORB);
	export_constant_npc(JT_G_DEVILING);
	export_constant_npc(JT_HEROS_WOLF);
	export_constant_npc(JT_HEROS_GINSENG);
	export_constant_npc(JT_HEROS_CANNON_R);
	export_constant_npc(JT_HEROS_CANNON_Y);
	export_constant_npc(JT_HEROS_CANNON_G);
	export_constant_npc(JT_HEROS_CANNON_B);
	export_constant_npc(JT_HEROS_R_PLANT);
	export_constant_npc(JT_HEROS_Y_PLANT);
	export_constant_npc(JT_HEROS_B_PLANT);
	export_constant_npc(JT_HEROS_W_PLANT);
	export_constant_npc(JT_HEROS_R_FERUS);
	export_constant_npc(JT_HEROS_G_FERUS);
	export_constant_npc(JT_HEROS_P_FERUS);
	export_constant_npc(JT_HEROS_WATCHER);
	export_constant_npc(JT_HEROS_KEEPER);
	export_constant_npc(JT_HEROS_F_PEGASUS);
	export_constant_npc(JT_G_HEROS_R_FERUS);
	export_constant_npc(JT_G_HEROS_G_FERUS);
	export_constant_npc(JT_G_HEROS_P_FERUS);
	export_constant_npc(JT_VR_WILD_ROSE);
	export_constant_npc(JT_VR_MD_LZ);
	export_constant_npc(JT_2210_EV_SPIDING);
	export_constant_npc(JT_MD_SEWER_THIEF_BUG);
	export_constant_npc(JT_MD_SEWER_CHONCHON);
	export_constant_npc(JT_MD_SEWER_AMBERNITE);
	export_constant_npc(JT_MD_SEWER_BEETLE);
	export_constant_npc(JT_MD_SEWER_ARCLOUSE);
	export_constant_npc(JT_MD_SEWER_ARGIOPE);
	export_constant_npc(JT_MD_SEWER_CAVE_FLOWER);
	export_constant_npc(JT_LARVA_VIOLET);
	export_constant_npc(JT_ECO_RUDO);
	export_constant_npc(JT_ECO_ARCHANGELING);
	export_constant_npc(JT_ECO_FAKE_ANGEL);
	export_constant_npc(JT_ECO_PLASMA_P);
	export_constant_npc(JT_ECO_SOLACE);
	export_constant_npc(JT_ECO_ANOPHELES);
	export_constant_npc(JT_ECO_GRYPHON);
	export_constant_npc(JT_ECO_RANDGRIS);
	export_constant_npc(JT_ECO_COMODO);
	export_constant_npc(JT_ECO_POISON_TOAD);
	export_constant_npc(JT_ECO_SIDE_WINDER);
	export_constant_npc(JT_ECO_CRAMP);
	export_constant_npc(JT_ECO_KUKRE);
	export_constant_npc(JT_ECO_NEPENTHES);
	export_constant_npc(JT_ECO_ANGRA_MANTIS);
	export_constant_npc(JT_ECO_VENOM_KIMERA);
	export_constant_npc(JT_ECO_NIGHTMARE);
	export_constant_npc(JT_ECO_WHISPER);
	export_constant_npc(JT_ECO_MARIONETTE);
	export_constant_npc(JT_ECO_NOXIOUS);
	export_constant_npc(JT_ECO_THE_PAPER);
	export_constant_npc(JT_ECO_GAJOMART);
	export_constant_npc(JT_ECO_ODIUM);
	export_constant_npc(JT_ECO_GLOOMUNDERNIGHT);
	export_constant_npc(JT_E_PORING_2023);
	export_constant_npc(JT_E_LUNATIC_2023);
	export_constant_npc(JT_BURNING_KNIGHT);
	export_constant_npc(JT_DEDSERA);
	export_constant_npc(JT_HARDROCK_TITAN);
	export_constant_npc(JT_DEADWEEN);
	export_constant_npc(JT_GAIA_POL);
	export_constant_npc(JT_PUNCH_BUG);
	export_constant_npc(JT_AFERDE);
	export_constant_npc(JT_DISPOL);
	export_constant_npc(JT_TIMBERS);
	export_constant_npc(JT_RENIRE);
	export_constant_npc(JT_G_BURNING_KNIGHT);
	export_constant_npc(JT_G_TIMBERS);
	export_constant_npc(JT_2301_EV_RICE_FLOUR);
	export_constant_npc(JT_EP20_ICEWIND1);
	export_constant_npc(JT_EP20_ICEWIND2);
	export_constant_npc(JT_EP20_EGGCOPO);
	export_constant_npc(JT_EP20_RABBIT_ICESLUG);
	export_constant_npc(JT_EP20_MELIBE_ICESLUG);
	export_constant_npc(JT_EP20_ICEBEAR);
	export_constant_npc(JT_EP20_JORMUNGUARD1);
	export_constant_npc(JT_EP20_JORMUNGUARD2);
	export_constant_npc(JT_EP20_FAKE_IWIN_SN);
	export_constant_npc(JT_EP20_FAKE_IWIN_SY);
	export_constant_npc(JT_EP20_FAKE_IWIN_SB);
	export_constant_npc(JT_EP20_FAKE_IWIN_SG);
	export_constant_npc(JT_EP20_FAKE_IWIN_SR);
	export_constant_npc(JT_EP20_DEMIGOD_LASGAND);
	export_constant_npc(JT_EP20_BOSS_CLANER);
	export_constant_npc(JT_MD_EP20_BOSS_LASGAND);
	export_constant_npc(JT_MD_EP20_FALLENANGEL);
	export_constant_npc(JT_EP20_ANGEL_ICESLUG);
	export_constant_npc(JT_EP20_ICEEGG);
	export_constant_npc(JT_EP20_RGAN_WARLOCK);
	export_constant_npc(JT_EP20_RGAN_HEALER);
	export_constant_npc(JT_EP20_JORGAN_WARLOCK);
	export_constant_npc(JT_EP20_JORGAN_HEALER);
	export_constant_npc(JT_EP20_JORGAN_GUARDIAN);
	export_constant_npc(JT_EP20_JORGAN_CLEANER);
	export_constant_npc(JT_MD_EP20_JOR_G_P);
	export_constant_npc(JT_MD_EP20_JOR_G_Y);
	export_constant_npc(JT_MD_EP20_JOR_WARLOCK);
	export_constant_npc(JT_EP20_MD_HEARTHUNTER1);
	export_constant_npc(JT_EP20_NPC_COCOPO);
	export_constant_npc(JT_EP20_SNOW_ANGEL);
	export_constant_npc(JT_G_EP20_JORMUNGUARD1);
	export_constant_npc(JT_G_EP20_JORMUNGUARD2);
	export_constant_npc(JT_G_EP20_JORGAN_CLEANER);
	export_constant_npc(JT_G_EP20_ANGEL_ICESLUG);
	export_constant_npc(JT_G_EP20_RGAN_WARLOCK);
	export_constant_npc(JT_G_EP20_JORGAN_HEALER);
	export_constant_npc(JT_G_EP20_JORGAN_GUARDIAN);
	export_constant_npc(JT_EP20_MD_BOX1);
	export_constant_npc(JT_EP20_MD_BOX2);
	export_constant_npc(JT_EP20_NPC_NYAR);
	export_constant_npc(JT_EP20_NPC_LASGAND);
	export_constant_npc(JT_BIO_ANOLIAN);
	export_constant_npc(JT_BIO_SKEL_ARCHER);
	export_constant_npc(JT_BIO_DRAGON_TAIL);
	export_constant_npc(JT_BIO_LAVA_TOAD);
	export_constant_npc(JT_BIO_LITTLE_FATUM);
	export_constant_npc(JT_BIO_STING);
	export_constant_npc(JT_BIO_EMPATHIZER);
	export_constant_npc(JT_BIO_FIRE_FRILLDORA);
	export_constant_npc(JT_BIO_HOLY_FRUS);
	export_constant_npc(JT_BIO_HOLY_SKOGUL);
	export_constant_npc(JT_BIO_KAPHA);
	export_constant_npc(JT_BIO_SKEL_SOLDIER);
	export_constant_npc(JT_BIO_PINGUICULA_D);
	export_constant_npc(JT_BIO_POM_SPIDER);
	export_constant_npc(JT_BIO_PRAY_GIVER);
	export_constant_npc(JT_BIO_WOOD_GOBLIN);
	export_constant_npc(JT_VR_MD_LAKE);
	export_constant_npc(JT_VR_MD_DESSERT);
	export_constant_npc(JT_VR_MD_SNOW);
	export_constant_npc(JT_VR_MD_OCEAN);
	export_constant_npc(JT_VR_MD_FOREST);
	export_constant_npc(JT_VR_MD_TILBY);
	export_constant_npc(JT_VR_MD_POPE);
	export_constant_npc(JT_VR_MD_TILBY2);
	export_constant_npc(JT_VR_MD_RAINBOW);
	export_constant_npc(JT_HEADSTONE1);
	export_constant_npc(JT_HEADSTONE2);
	export_constant_npc(JT_HEADSTONE3);
	export_constant_npc(JT_HEADSTONE4);
	export_constant_npc(JT_HEADSTONE0);
	export_constant_npc(JT_MD_COMMON_BOSS);
	export_constant_npc(JT_MD_PRI_RIGEL);
	export_constant_npc(JT_MD_PRI_RIGEL_AC);
	export_constant_npc(JT_MD_PRI_RIGEL_ACS);
	export_constant_npc(JT_MD_PRI_DRAGON_1);
	export_constant_npc(JT_MD_PRI_DRAGON_2);
	export_constant_npc(JT_MD_PRI_DRAGON_3);
	export_constant_npc(JT_MD_PRI_DRAGON_4);
	export_constant_npc(JT_MD_COMMON_P);
	export_constant_npc(JT_MD_COMMON_SG);
	export_constant_npc(JT_MD_MANASTORM);
	export_constant_npc(JT_MD_MANABARRIER);
	export_constant_npc(JT_DARK_LORD2);
	export_constant_npc(JT_E_NF_BUG);
	export_constant_npc(JT_E_NF_FLY);
	export_constant_npc(JT_E_NF_SMALLRAT);
	export_constant_npc(JT_E_NF_BIGRAT);
	export_constant_npc(JT_SPIRIT_G_LAND_S);
	export_constant_npc(JT_SPIRIT_G_LAND_M);
	export_constant_npc(JT_SPIRIT_G_LAND_L);
	export_constant_npc(JT_SPIRIT_G_LAND_SL);
	export_constant_npc(JT_SPIRIT_B_FLAME_S);
	export_constant_npc(JT_SPIRIT_B_FLAME_M);
	export_constant_npc(JT_SPIRIT_B_FLAME_L);
	export_constant_npc(JT_SPIRIT_B_FLAME_SL);
	export_constant_npc(JT_SPIRIT_S_WIND_S);
	export_constant_npc(JT_SPIRIT_S_WIND_M);
	export_constant_npc(JT_SPIRIT_S_WIND_L);
	export_constant_npc(JT_SPIRIT_S_WIND_SL);
	export_constant_npc(JT_SPIRIT_I_WATER_S);
	export_constant_npc(JT_SPIRIT_I_WATER_M);
	export_constant_npc(JT_SPIRIT_I_WATER_L);
	export_constant_npc(JT_SPIRIT_I_WATER_SL);
	export_constant_npc(JT_SPIRIT_C_LAND_S);
	export_constant_npc(JT_SPIRIT_C_LAND_M);
	export_constant_npc(JT_SPIRIT_C_LAND_L);
	export_constant_npc(JT_SPIRIT_C_LAND_SL);
	export_constant_npc(JT_SPIRIT_C_FLAME_S);
	export_constant_npc(JT_SPIRIT_C_FLAME_M);
	export_constant_npc(JT_SPIRIT_C_FLAME_L);
	export_constant_npc(JT_SPIRIT_C_FLAME_SL);
	export_constant_npc(JT_SPIRIT_H_WATER_S);
	export_constant_npc(JT_SPIRIT_H_WATER_M);
	export_constant_npc(JT_SPIRIT_H_WATER_L);
	export_constant_npc(JT_SPIRIT_H_WATER_SL);
	export_constant_npc(JT_SPIRIT_D_WIND_S);
	export_constant_npc(JT_SPIRIT_D_WIND_M);
	export_constant_npc(JT_SPIRIT_D_WIND_L);
	export_constant_npc(JT_SPIRIT_D_WIND_SL);
	export_constant_npc(JT_SPIRIT_R_FLAME_S);
	export_constant_npc(JT_SPIRIT_R_FLAME_M);
	export_constant_npc(JT_SPIRIT_R_FLAME_L);
	export_constant_npc(JT_SPIRIT_R_FLAME_SL);
	export_constant_npc(JT_SPIRIT_F_LAND_S);
	export_constant_npc(JT_SPIRIT_F_LAND_M);
	export_constant_npc(JT_SPIRIT_F_LAND_L);
	export_constant_npc(JT_SPIRIT_F_LAND_SL);
	export_constant_npc(JT_SPIRIT_C_WATER_S);
	export_constant_npc(JT_SPIRIT_C_WATER_M);
	export_constant_npc(JT_SPIRIT_C_WATER_L);
	export_constant_npc(JT_SPIRIT_C_WATER_SL);
	export_constant_npc(JT_SPIRIT_C_WIND_S);
	export_constant_npc(JT_SPIRIT_C_WIND_M);
	export_constant_npc(JT_SPIRIT_C_WIND_L);
	export_constant_npc(JT_SPIRIT_C_WIND_SL);
	export_constant_npc(JT_VR_SONIC_WALK);
	export_constant_npc(JT_VR_SONIC_SPIN);
	export_constant_npc(JT_VR_TALES);
	export_constant_npc(JT_VR_MD_METALSONIC);
	export_constant_npc(JT_VR_MD_KNUCKLES);
	export_constant_npc(JT_VR_MD_DREGG1);
	export_constant_npc(JT_VR_MD_DREGG2);
	export_constant_npc(JT_VR_MD_MEGALITH_SONIC);
	export_constant_npc(JT_VR_MD_SPORE_SONIC);
	export_constant_npc(JT_VR_MD_SAVAGE_SONIC);
	export_constant_npc(JT_VR_MD_ANGELING_SONIC);
	export_constant_npc(JT_VR_MD_HEATER_SONIC);
	export_constant_npc(JT_BIO_DUNEYRR);
	export_constant_npc(JT_BIO_NAGA);
	export_constant_npc(JT_BIO_ANCIENT_TREE);
	export_constant_npc(JT_BIO_DOLLOCARIS);
	export_constant_npc(JT_BIO_ICE_GARGOYLE);
	export_constant_npc(JT_BIO_FLAME_GHOST);
	export_constant_npc(JT_BIO_ACIDUS_);
	export_constant_npc(JT_BIO_MOROCC_1);
	export_constant_npc(JT_BIO_SALAMANDER);
	export_constant_npc(JT_BIO_MOSKILLO);
	export_constant_npc(JT_2311_EV_BLACK_BEAR);
	export_constant_npc(JT_2311_EV_GOLD_PIG);
	export_constant_npc(JT_2401_EV_DRAGORING);
	export_constant_npc(JT_2401_EV_IMOOGI);
	export_constant_npc(JT_VR_CHAO);
	export_constant_npc(JT_MD_Airboat_Boss5);
	export_constant_npc(JT_DARK_ILLUSION2);
	export_constant_npc(JT_MD_RIGEL);
	export_constant_npc(JT_20TH_EVENT_HEMEL);
	export_constant_npc(JT_20TH_EVENT_LOLI_RURI);
	export_constant_npc(JT_20TH_EVENT_GIBBET);
	export_constant_npc(JT_20TH_EVENT_HYLOZOIST);
	export_constant_npc(JT_20TH_EVENT_MURDERER);
	export_constant_npc(JT_20TH_EVENT_CORPS);
	export_constant_npc(JT_20TH_EVENT_CO_CMDER);
	export_constant_npc(JT_EP20_ARMOERDCOPO);	
	export_constant_npc(JT_NEW_NPC_4RD_END);
