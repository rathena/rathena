...
/// @APIHOOK_START(EFST_CONST)
	...
	//-- Healer
	export_constant(EFST_HEAL);
	
	//-- PK
	export_constant(EFST_PVPMODE);
	export_constant(EFST_NOCHATPK);
	...
	//-- Security & Refresh
	export_constant(EFST_SECURITY);
	export_constant(EFST_AUTOREFRESH);
	...
	//-- Job Bonus 
	export_constant(EFST_novice_job_i);
	export_constant(EFST_acolyte_job_i);
	export_constant(EFST_archer_job_i);
	export_constant(EFST_mage_job_i);
	export_constant(EFST_merchant_job_i);
	export_constant(EFST_sword_job_i);
	export_constant(EFST_thief_job_i);

	//-- Job Others
	export_constant(EFST_WOE_OLDTIMES);
	export_constant(EFST_NOCOSTUMES);
	export_constant(EFST_NOMASCOT);
	export_constant(EFST_NOPALETTES);
	export_constant(EFST_NOPETATTACK);
	export_constant(EFST_PARTY_BUFFS);
	export_constant(EFST_PET_LIFEINSURANCE);
	export_constant(EFST_WORLDBOSS);
	export_constant(EFST_DUNGEON_TEMP);
	export_constant(EFST_CHEFFENIA_TEMP);
	export_constant(EFST_DPS_CALCULATION);
	export_constant(EFST_CHAR_COMPETITIVE);
	export_constant(EFST_CELL_MVPNODAMAGE);
	export_constant(EFST_ANTIBOT);
	export_constant(EFST_DONTFORGETME1);
	export_constant(EFST_EVENT_DOUBLEEXP);
	export_constant(EFST_ITEM_AUTOBONUS);
	export_constant(EFST_MAP_ENHANCEMENT);
	
	//-- RESET
	export_constant(EFST_CHAR_RESET_0);
	export_constant(EFST_CHAR_RESET_1);
	export_constant(EFST_CHAR_RESET_2);
	export_constant(EFST_CHAR_RESET_3);
	export_constant(EFST_CHAR_RESET_4);
	export_constant(EFST_CHAR_RESET_5);
	export_constant(EFST_CHAR_RESET_6);
	export_constant(EFST_CHAR_RESET_7);
	export_constant(EFST_CHAR_RESET_8);
/// @APIHOOK_END
