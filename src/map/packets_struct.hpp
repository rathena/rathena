...
struct PACKET_ZC_ADD_ACCOUNT_LIMTIED_SALE_ITEM {
	int16 packetType;
	int16 result;
} __attribute__((packed));
DEFINE_PACKET_HEADER(ZC_ADD_ACCOUNT_LIMTIED_SALE_ITEM, 0x0b49);

struct PACKET_CZ_DEL_ACCOUNT_LIMTIED_SALE_ITEM {
	int16 packetType;
	uint32 ItemID;
} __attribute__((packed));
DEFINE_PACKET_HEADER(CZ_DEL_ACCOUNT_LIMTIED_SALE_ITEM, 0x0b4a);

struct PACKET_ZC_DEL_ACCOUNT_LIMTIED_SALE_ITEM {
	int16 packetType;
	int16 result;
} __attribute__((packed));
DEFINE_PACKET_HEADER(ZC_DEL_ACCOUNT_LIMTIED_SALE_ITEM, 0x0b4b);

struct PACKET_ZC_GET_ACCOUNT_LIMTIED_SALE_LIST_sub {
	uint32 item_id;
	uint32 total_amount;
	uint32 amount;
	uint32 price;
...
struct PACKET_ZC_GET_ACCOUNT_LIMTIED_SALE_LIST {
	int16 packetType;
	int16 packetLength;
	int16 flag;
	struct PACKET_ZC_GET_ACCOUNT_LIMTIED_SALE_LIST_sub list[];
} __attribute__((packed));
DEFINE_PACKET_HEADER(ZC_GET_ACCOUNT_LIMTIED_SALE_LIST, 0x0b4d);

struct PACKET_CZ_OPEN_ACCOUNT_LIMTIED_SALE_TOOL {
	int16 packetType;
} __attribute__((packed));
DEFINE_PACKET_HEADER(CZ_OPEN_ACCOUNT_LIMTIED_SALE_TOOL, 0x0b4f);

struct PACKET_ZC_OPEN_ACCOUNT_LIMTIED_SALE_TOOL {
	int16 packetType;
} __attribute__((packed));
DEFINE_PACKET_HEADER(ZC_OPEN_ACCOUNT_LIMTIED_SALE_TOOL, 0x0b50);

struct PACKET_CZ_CLOSE_ACCOUNT_LIMTIED_SALE_TOOL {
	int16 packetType;
} __attribute__((packed));
DEFINE_PACKET_HEADER(CZ_CLOSE_ACCOUNT_LIMTIED_SALE_TOOL, 0x0b51);

struct PACKET_ZC_CLOSE_ACCOUNT_LIMTIED_SALE_TOOL {
	int16 packetType;
} __attribute__((packed));
DEFINE_PACKET_HEADER(ZC_CLOSE_ACCOUNT_LIMTIED_SALE_TOOL, 0x0b52);

struct PACKET_CZ_SEARCH_ACCOUNT_LIMTIED_SALE_ITEM {
	int16 packetType;
	char ItemName[50];
} __attribute__((packed));
DEFINE_PACKET_HEADER(CZ_SEARCH_ACCOUNT_LIMTIED_SALE_ITEM, 0x0b53);

struct PACKET_ZC_SEARCH_ACCOUNT_LIMTIED_SALE_ITEM {
	int16 packetType;
	int16 result;
	uint32 ItemID;
} __attribute__((packed));
DEFINE_PACKET_HEADER(ZC_SEARCH_ACCOUNT_LIMTIED_SALE_ITEM, 0x0b54);

struct PACKET_CZ_ADD_ACCOUNT_LIMTIED_SALE_ITEM2 {
	int16 packetType;
	uint32 ItemID;
	uint32 amount;
	uint32 startTime;
...
DEFINE_PACKET_HEADER(CZ_ADD_ACCOUNT_LIMTIED_SALE_ITEM2, 0x0bac);
...
struct PACKET_ZC_REWARD_INFO_RUNE_sub {
	uint32 runesetid;
	uint8 reward;
} __attribute__((packed));

struct PACKET_ZC_REWARD_INFO_RUNE {
	int16 packetType;
	int16 packetLength;
	uint8 unknown;
	uint16 tagID;
	uint16 set_amount; //number of set activated
	struct PACKET_ZC_REWARD_INFO_RUNE_sub setreward_rune[];
} __attribute__((packed));
DEFINE_PACKET_HEADER(ZC_REWARD_INFO_RUNE, 0x0c15);

struct PACKET_CZ_RUNE_ASK_REWARD {
	int16 packetType;
	uint16 tagID;
	uint32 runesetid;
	uint8 reward;
} __attribute__((packed));
DEFINE_PACKET_HEADER(CZ_RUNE_ASK_REWARD, 0x0c16);

struct PACKET_ZC_RUNE_RESULT_REWARD {
	int16 packetType;
	uint8 result;
	uint16 tagID;
	uint32 runesetid;
...
DEFINE_PACKET_HEADER(ZC_RUNE_RESULT_REWARD, 0x0c17);
#endif
