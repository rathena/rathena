...
struct script_code* parse_script_(const char* src,
								  const char* file,
								  int32 line,
								  int32 options,
								  const char* src_file,
...
void setd_sub_num(
	struct script_state* st, map_session_data* sd, const char* varname, int32 elem, int64 value, struct reg_db* ref);
void setd_sub_str(struct script_state* st,
				  map_session_data* sd,
				  const char* varname,
				  int32 elem,
				  const char* value,
