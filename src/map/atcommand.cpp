...
/*=========================================
 * Verifica os valores de resistência as raças
...
ACMD_FUNC(resistencia) {
	...
	struct {
		...
		{ "   [ %d ] Resistência à raça Anjo", 0 },
		{ "   [ %d ] Resistência à raça Bruto", 0 },
		{ "   [ %d ] Resistência à raça Demi-Humano", 0 },
		{ "   [ %d ] Resistência à raça Demônio", 0 },
		{ "   [ %d ] Resistência à raça Dragão", 0 },
		{ "   [ %d ] Resistência à raça Peixe", 0 },
		{ "   [ %d ] Resistência à raça Amorfo", 0 },
		{ "   [ %d ] Resistência à raça Inseto", 0 },
		{ "   [ %d ] Resistência à raça Planta", 0 },
		{ "   [ %d ] Resistência à raça Humanóide", 0 },
		{ "   [ %d ] Resistência à raça Morto-Vivo", 0 },
		{ "   [ %d ] Resistência à raça Doram", 0 },
		{ "   [ %d ] Resistência à todas as Raças", 0 },
		{ NULL, 0 }
	};
	memset(output, '\0', sizeof(output));
	clif_displaymessage(sd->fd, "=========== Resistência à Raças ===========");
