...
// Cap int input to numeric limits of target value and safecast it
// @param input: int value
// @return static_cast<decltype(T)> capped min/max value
template <typename T>
static forceinline T script_setunitdata_helper(int input) {
	return static_cast<T>(std::clamp(input, static_cast<int>(std::numeric_limits<T>::min()), static_cast<int>(std::numeric_limits<T>::max())));
}
...
BUILDIN_FUNC(setunitdata)
{
	...
	case BL_MOB: {
		...
		switch (type) {
			case UMOB_SIZE: md->status.size = md->base_status->size = script_setunitdata_helper<unsigned char>(value); break;
			case UMOB_LEVEL: md->level = script_setunitdata_helper<unsigned short>(value); clif_name_area(&md->bl); break;
			case UMOB_HP: md->base_status->hp = script_setunitdata_helper<unsigned int>(value); status_set_hp(bl, script_setunitdata_helper<unsigned int>(value), 0); clif_name_area(&md->bl); break;
			case UMOB_MAXHP: md->base_status->hp = md->base_status->max_hp = script_setunitdata_helper<unsigned int>(value); status_set_maxhp(bl, script_setunitdata_helper<unsigned int>(value), 0); clif_name_area(&md->bl); break;
			case UMOB_MASTERAID: md->master_id = value; break;
			case UMOB_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, script_setunitdata_helper<short>(value), 0, 0, CLR_TELEPORT); break;
			case UMOB_X: if (!unit_walktoxy(bl, script_setunitdata_helper<short>(value), md->bl.y, 2)) unit_movepos(bl, script_setunitdata_helper<short>(value), md->bl.y, 0, 0); break;
			case UMOB_Y: if (!unit_walktoxy(bl, md->bl.x, script_setunitdata_helper<short>(value), 2)) unit_movepos(bl, md->bl.x, script_setunitdata_helper<short>(value), 0, 0); break;
			case UMOB_SPEED: md->base_status->speed = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_MODE:
			...
			case UMOB_HEADBOTTOM: clif_changelook(bl, LOOK_HEAD_BOTTOM, script_setunitdata_helper<unsigned short>(value)); break;
			case UMOB_HEADMIDDLE: clif_changelook(bl, LOOK_HEAD_MID, script_setunitdata_helper<unsigned short>(value)); break;
			case UMOB_HEADTOP: clif_changelook(bl, LOOK_HEAD_TOP, script_setunitdata_helper<unsigned short>(value)); break;
			case UMOB_CLOTHCOLOR: clif_changelook(bl, LOOK_CLOTHES_COLOR, script_setunitdata_helper<unsigned short>(value)); break;
			case UMOB_SHIELD: clif_changelook(bl, LOOK_SHIELD, script_setunitdata_helper<unsigned short>(value)); break;
			case UMOB_WEAPON: clif_changelook(bl, LOOK_WEAPON, script_setunitdata_helper<unsigned short>(value)); break;
			case UMOB_LOOKDIR: unit_setdir(bl, script_setunitdata_helper<uint8>(value)); break;
			case UMOB_CANMOVETICK: md->ud.canmove_tick = value > 0 ? script_setunitdata_helper<t_tick>(value) : 0; break;
			case UMOB_STR: md->base_status->str = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_AGI: md->base_status->agi = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_VIT: md->base_status->vit = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_INT: md->base_status->int_ = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_DEX: md->base_status->dex = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			case UMOB_LUK: md->base_status->luk = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &md->status, md->level); calc_status = true; break;
			...
			case UMOB_ATKRANGE: md->base_status->rhw.range = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UMOB_ATKMIN: md->base_status->rhw.atk = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UMOB_ATKMAX: md->base_status->rhw.atk2 = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UMOB_MATKMIN: md->base_status->matk_min = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UMOB_MATKMAX: md->base_status->matk_max = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UMOB_DEF: md->base_status->def = script_setunitdata_helper<defType>(value); calc_status = true; break;
			case UMOB_MDEF: md->base_status->mdef = script_setunitdata_helper<defType>(value); calc_status = true; break;
			case UMOB_HIT: md->base_status->hit = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMOB_FLEE: md->base_status->flee = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMOB_PDODGE: md->base_status->flee2 = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMOB_CRIT: md->base_status->cri = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMOB_RACE: md->status.race = md->base_status->race = script_setunitdata_helper<unsigned char>(value); break;
			case UMOB_ELETYPE: md->base_status->def_ele = script_setunitdata_helper<unsigned char>(value); calc_status = true; break;
			case UMOB_ELELEVEL: md->base_status->ele_lv = script_setunitdata_helper<unsigned char>(value); calc_status = true; break;
			case UMOB_AMOTION: md->base_status->amotion = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMOB_ADELAY: md->base_status->adelay = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMOB_DMOTION: md->base_status->dmotion = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMOB_TARGETID: {
				if (value==0) {
			...
			case UMOB_ROBE: clif_changelook(bl, LOOK_ROBE, script_setunitdata_helper<unsigned short>(value)); break;
			case UMOB_BODY2: clif_changelook(bl, LOOK_BODY2, script_setunitdata_helper<unsigned short>(value)); break;
			...
			case UMOB_RES: md->base_status->res = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMOB_MRES: md->base_status->mres = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMOB_DAMAGETAKEN: md->damagetaken = script_setunitdata_helper<unsigned short>(value); break;
			default:
	...
	case BL_HOM: {
		...
		switch (type) {
			case UHOM_SIZE: hd->battle_status.size = hd->base_status.size = script_setunitdata_helper<unsigned char>(value); break;
			case UHOM_LEVEL: hd->homunculus.level = script_setunitdata_helper<unsigned short>(value); break;
			case UHOM_HP: hd->base_status.hp = script_setunitdata_helper<unsigned int>(value); status_set_hp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UHOM_MAXHP: hd->base_status.hp = hd->base_status.max_hp = script_setunitdata_helper<unsigned int>(value); status_set_maxhp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UHOM_SP: hd->base_status.sp = script_setunitdata_helper<unsigned int>(value); status_set_sp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UHOM_MAXSP: hd->base_status.sp = hd->base_status.max_sp = script_setunitdata_helper<unsigned int>(value); status_set_maxsp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UHOM_MASTERCID: hd->homunculus.char_id = script_setunitdata_helper<uint32>(value); break;
			case UHOM_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, script_setunitdata_helper<short>(value), 0, 0, CLR_TELEPORT); break;
			case UHOM_X: if (!unit_walktoxy(bl, script_setunitdata_helper<short>(value), hd->bl.y, 2)) unit_movepos(bl, script_setunitdata_helper<short>(value), hd->bl.y, 0, 0); break;
			case UHOM_Y: if (!unit_walktoxy(bl, hd->bl.x, script_setunitdata_helper<short>(value), 2)) unit_movepos(bl, hd->bl.x, script_setunitdata_helper<short>(value), 0, 0); break;
			case UHOM_HUNGER: hd->homunculus.hunger = script_setunitdata_helper<short>(value); clif_send_homdata(*hd, SP_HUNGRY); break;
			case UHOM_INTIMACY: hom_increase_intimacy(hd, script_setunitdata_helper<unsigned int>(value)); clif_send_homdata(*hd, SP_INTIMATE); break;
			case UHOM_SPEED: hd->base_status.speed = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_LOOKDIR: unit_setdir(bl, script_setunitdata_helper<uint8>(value)); break;
			case UHOM_CANMOVETICK: hd->ud.canmove_tick = value > 0 ? script_setunitdata_helper<unsigned int>(value) : 0; break;
			case UHOM_STR: hd->base_status.str = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_AGI: hd->base_status.agi = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_VIT: hd->base_status.vit = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_INT: hd->base_status.int_ = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_DEX: hd->base_status.dex = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_LUK: hd->base_status.luk = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &hd->base_status, hd->homunculus.level); calc_status = true; break;
			case UHOM_DMGIMMUNE: hd->ud.immune_attack = value > 0; break;
			case UHOM_ATKRANGE: hd->base_status.rhw.range = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UHOM_ATKMIN: hd->base_status.rhw.atk = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UHOM_ATKMAX: hd->base_status.rhw.atk2 = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UHOM_MATKMIN: hd->base_status.matk_min = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UHOM_MATKMAX: hd->base_status.matk_max = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UHOM_DEF: hd->base_status.def = script_setunitdata_helper<defType>(value); calc_status = true; break;
			case UHOM_MDEF: hd->base_status.mdef = script_setunitdata_helper<defType>(value); calc_status = true; break;
			case UHOM_HIT: hd->base_status.hit = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UHOM_FLEE: hd->base_status.flee = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UHOM_PDODGE: hd->base_status.flee2 = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UHOM_CRIT: hd->base_status.cri = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UHOM_RACE: hd->battle_status.race = hd->base_status.race = script_setunitdata_helper<unsigned char>(value); break;
			case UHOM_ELETYPE: hd->base_status.def_ele = script_setunitdata_helper<unsigned char>(value); calc_status = true; break;
			case UHOM_ELELEVEL: hd->base_status.ele_lv = script_setunitdata_helper<unsigned char>(value); calc_status = true; break;
			case UHOM_AMOTION: hd->base_status.amotion = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UHOM_ADELAY: hd->base_status.adelay = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UHOM_DMOTION: hd->base_status.dmotion = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UHOM_TARGETID: {
				if (value==0) {
	...
	case BL_PET: {
		...
		switch (type) {
			case UPET_SIZE: pd->status.size = script_setunitdata_helper<unsigned char>(value); break;
			case UPET_LEVEL: pd->pet.level = script_setunitdata_helper<unsigned short>(value); break;
			case UPET_HP: pd->status.hp = pd->status.max_hp = script_setunitdata_helper<unsigned int>(value); status_set_hp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UPET_MAXHP: pd->status.hp = pd->status.max_hp = script_setunitdata_helper<unsigned int>(value); status_set_maxhp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UPET_MASTERAID: pd->pet.account_id = script_setunitdata_helper<unsigned int>(value); break;
			case UPET_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, script_setunitdata_helper<short>(value), 0, 0, CLR_TELEPORT); break;
			case UPET_X: if (!unit_walktoxy(bl, script_setunitdata_helper<short>(value), pd->bl.y, 2)) unit_movepos(bl, script_setunitdata_helper<short>(value), pd->bl.y, 0, 0); break;
			case UPET_Y: if (!unit_walktoxy(bl, pd->bl.x, script_setunitdata_helper<short>(value), 2)) unit_movepos(bl, pd->bl.x, script_setunitdata_helper<short>(value), 0, 0); break;
			case UPET_HUNGER: pd->pet.hungry = cap_value(script_setunitdata_helper<short>(value), 0, 100); clif_send_petdata(map_id2sd(pd->pet.account_id), pd, 2, pd->pet.hungry); break;
			case UPET_INTIMACY: pet_set_intimate(pd, script_setunitdata_helper<unsigned int>(value)); clif_send_petdata(map_id2sd(pd->pet.account_id), pd, 1, pd->pet.intimate); break;
			case UPET_SPEED: pd->status.speed = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_LOOKDIR: unit_setdir(bl, script_setunitdata_helper<uint8>(value)); break;
			case UPET_CANMOVETICK: pd->ud.canmove_tick = value > 0 ? script_setunitdata_helper<unsigned int>(value) : 0; break;
			case UPET_STR: pd->status.str = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_AGI: pd->status.agi = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_VIT: pd->status.vit = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_INT: pd->status.int_ = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_DEX: pd->status.dex = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_LUK: pd->status.luk = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &pd->status, pd->pet.level); break;
			case UPET_DMGIMMUNE: pd->ud.immune_attack = value > 0; break;
			case UPET_ATKRANGE: pd->status.rhw.range = script_setunitdata_helper<unsigned short>(value); break;
			case UPET_ATKMIN: pd->status.rhw.atk = script_setunitdata_helper<unsigned short>(value); break;
			case UPET_ATKMAX: pd->status.rhw.atk2 = script_setunitdata_helper<unsigned short>(value); break;
			case UPET_MATKMIN: pd->status.matk_min = script_setunitdata_helper<unsigned short>(value); break;
			case UPET_MATKMAX: pd->status.matk_max = script_setunitdata_helper<unsigned short>(value); break;
			case UPET_DEF: pd->status.def = script_setunitdata_helper<defType>(value); break;
			case UPET_MDEF: pd->status.mdef = script_setunitdata_helper<defType>(value); break;
			case UPET_HIT: pd->status.hit = script_setunitdata_helper<short>(value); break;
			case UPET_FLEE: pd->status.flee = script_setunitdata_helper<short>(value); break;
			case UPET_PDODGE: pd->status.flee2 = script_setunitdata_helper<short>(value); break;
			case UPET_CRIT: pd->status.cri = script_setunitdata_helper<short>(value); break;
			case UPET_RACE: pd->status.race = script_setunitdata_helper<unsigned char>(value); break;
			case UPET_ELETYPE: pd->status.def_ele = script_setunitdata_helper<unsigned char>(value); break;
			case UPET_ELELEVEL: pd->status.ele_lv = script_setunitdata_helper<unsigned char>(value); break;
			case UPET_AMOTION: pd->status.amotion = script_setunitdata_helper<short>(value); break;
			case UPET_ADELAY: pd->status.adelay = script_setunitdata_helper<short>(value); break;
			case UPET_DMOTION: pd->status.dmotion = script_setunitdata_helper<short>(value); break;
	...
	case BL_MER: {
		...
		switch (type) {
			case UMER_SIZE: mc->battle_status.size = mc->base_status.size = script_setunitdata_helper<unsigned char>(value); break;
			case UMER_HP: mc->base_status.hp = script_setunitdata_helper<unsigned int>(value); status_set_hp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UMER_MAXHP: mc->base_status.hp = mc->base_status.max_hp = script_setunitdata_helper<unsigned int>(value); status_set_maxhp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UMER_MASTERCID: mc->mercenary.char_id = script_setunitdata_helper<uint32>(value); break;
			case UMER_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, script_setunitdata_helper<short>(value), 0, 0, CLR_TELEPORT); break;
			case UMER_X: if (!unit_walktoxy(bl, script_setunitdata_helper<short>(value), mc->bl.y, 2)) unit_movepos(bl, script_setunitdata_helper<short>(value), mc->bl.y, 0, 0); break;
			case UMER_Y: if (!unit_walktoxy(bl, mc->bl.x, script_setunitdata_helper<short>(value), 2)) unit_movepos(bl, mc->bl.x, script_setunitdata_helper<short>(value), 0, 0); break;
			case UMER_KILLCOUNT: mc->mercenary.kill_count = script_setunitdata_helper<unsigned int>(value); break;
			case UMER_LIFETIME: mc->mercenary.life_time = script_setunitdata_helper<unsigned int>(value); break;
			case UMER_SPEED: mc->base_status.speed = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_LOOKDIR: unit_setdir(bl, script_setunitdata_helper<uint8>(value)); break;
			case UMER_CANMOVETICK: mc->ud.canmove_tick = value > 0 ? script_setunitdata_helper<unsigned int>(value) : 0; break;
			case UMER_STR: mc->base_status.str = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_AGI: mc->base_status.agi = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_VIT: mc->base_status.vit = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_INT: mc->base_status.int_ = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_DEX: mc->base_status.dex = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_LUK: mc->base_status.luk = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &mc->base_status, mc->db->lv); calc_status = true; break;
			case UMER_DMGIMMUNE: mc->ud.immune_attack = value > 0; break;
			case UMER_ATKRANGE: mc->base_status.rhw.range = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UMER_ATKMIN: mc->base_status.rhw.atk = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UMER_ATKMAX: mc->base_status.rhw.atk2 = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UMER_MATKMIN: mc->base_status.matk_min = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UMER_MATKMAX: mc->base_status.matk_max = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UMER_DEF: mc->base_status.def = script_setunitdata_helper<defType>(value); calc_status = true; break;
			case UMER_MDEF: mc->base_status.mdef = script_setunitdata_helper<defType>(value); calc_status = true; break;
			case UMER_HIT: mc->base_status.hit = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMER_FLEE: mc->base_status.flee = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMER_PDODGE: mc->base_status.flee2 = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMER_CRIT: mc->base_status.cri = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMER_RACE: mc->battle_status.race = mc->base_status.race = script_setunitdata_helper<unsigned char>(value); break;
			case UMER_ELETYPE: mc->base_status.def_ele = script_setunitdata_helper<unsigned char>(value); calc_status = true; break;
			case UMER_ELELEVEL: mc->base_status.ele_lv = script_setunitdata_helper<unsigned char>(value); calc_status = true; break;
			case UMER_AMOTION: mc->base_status.amotion = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMER_ADELAY: mc->base_status.adelay = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMER_DMOTION: mc->base_status.dmotion = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UMER_TARGETID: {
				if (value==0) {
	...
	case BL_ELEM: {
		...
		switch (type) {
			case UELE_SIZE: ed->battle_status.size = ed->base_status.size = script_setunitdata_helper<unsigned char>(value); break;
			case UELE_HP: ed->base_status.hp = script_setunitdata_helper<unsigned int>(value); status_set_hp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UELE_MAXHP: ed->base_status.hp = ed->base_status.max_hp = script_setunitdata_helper<unsigned int>(value); status_set_maxhp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UELE_SP: ed->base_status.sp = script_setunitdata_helper<unsigned int>(value); status_set_sp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UELE_MAXSP: ed->base_status.sp = ed->base_status.max_sp = script_setunitdata_helper<unsigned int>(value); status_set_maxsp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UELE_MASTERCID: ed->elemental.char_id = script_setunitdata_helper<uint32>(value); break;
			case UELE_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, script_setunitdata_helper<short>(value), 0, 0, CLR_TELEPORT); break;
			case UELE_X: if (!unit_walktoxy(bl, script_setunitdata_helper<short>(value), ed->bl.y, 2)) unit_movepos(bl, script_setunitdata_helper<short>(value), ed->bl.y, 0, 0); break;
			case UELE_Y: if (!unit_walktoxy(bl, ed->bl.x, script_setunitdata_helper<short>(value), 2)) unit_movepos(bl, ed->bl.x, script_setunitdata_helper<short>(value), 0, 0); break;
			case UELE_LIFETIME: ed->elemental.life_time = script_setunitdata_helper<unsigned int>(value); break;
			case UELE_MODE: ed->elemental.mode = (enum e_mode)value; calc_status = true; break;
			case UELE_SPEED: ed->base_status.speed = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_LOOKDIR: unit_setdir(bl, script_setunitdata_helper<uint8>(value)); break;
			case UELE_CANMOVETICK: ed->ud.canmove_tick = value > 0 ? script_setunitdata_helper<unsigned int>(value) : 0; break;
			case UELE_STR: ed->base_status.str = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_AGI: ed->base_status.agi = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_VIT: ed->base_status.vit = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_INT: ed->base_status.int_ = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_DEX: ed->base_status.dex = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_LUK: ed->base_status.luk = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &ed->base_status, ed->db->lv); calc_status = true; break;
			case UELE_DMGIMMUNE: ed->ud.immune_attack = value > 0; break;
			case UELE_ATKRANGE: ed->base_status.rhw.range = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UELE_ATKMIN: ed->base_status.rhw.atk = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UELE_ATKMAX: ed->base_status.rhw.atk2 = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UELE_MATKMIN: ed->base_status.matk_min = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UELE_MATKMAX: ed->base_status.matk_max = script_setunitdata_helper<unsigned short>(value); calc_status = true; break;
			case UELE_DEF: ed->base_status.def = script_setunitdata_helper<defType>(value); calc_status = true; break;
			case UELE_MDEF: ed->base_status.mdef = script_setunitdata_helper<defType>(value); calc_status = true; break;
			case UELE_HIT: ed->base_status.hit = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UELE_FLEE: ed->base_status.flee = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UELE_PDODGE: ed->base_status.flee2 = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UELE_CRIT: ed->base_status.cri = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UELE_RACE: ed->battle_status.race = ed->base_status.race = script_setunitdata_helper<unsigned char>(value); break;
			case UELE_ELETYPE: ed->base_status.def_ele = script_setunitdata_helper<unsigned char>(value); calc_status = true; break;
			case UELE_ELELEVEL: ed->base_status.ele_lv = script_setunitdata_helper<unsigned char>(value); calc_status = true; break;
			case UELE_AMOTION: ed->base_status.amotion = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UELE_ADELAY: ed->base_status.adelay = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UELE_DMOTION: ed->base_status.dmotion = script_setunitdata_helper<short>(value); calc_status = true; break;
			case UELE_TARGETID: {
				if (value==0) {
	...
	case BL_NPC: {
		...
		switch (type) {
			case UNPC_LEVEL: nd->level = script_setunitdata_helper<unsigned int>(value); break;
			case UNPC_HP: nd->status.hp = script_setunitdata_helper<unsigned int>(value); status_set_hp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UNPC_MAXHP: nd->status.hp = nd->status.max_hp = script_setunitdata_helper<unsigned int>(value); status_set_maxhp(bl, script_setunitdata_helper<unsigned int>(value), 0); break;
			case UNPC_MAPID: if (mapname) value = map_mapname2mapid(mapname); unit_warp(bl, script_setunitdata_helper<short>(value), 0, 0, CLR_TELEPORT); break;
			case UNPC_X: if (!unit_walktoxy(bl, script_setunitdata_helper<short>(value), nd->bl.y, 2)) unit_movepos(bl, script_setunitdata_helper<short>(value), nd->bl.x, 0, 0); break;
			case UNPC_Y: if (!unit_walktoxy(bl, nd->bl.x, script_setunitdata_helper<short>(value), 2)) unit_movepos(bl, nd->bl.x, script_setunitdata_helper<short>(value), 0, 0); break;
			case UNPC_LOOKDIR: unit_setdir(bl, script_setunitdata_helper<uint8>(value)); break;
			case UNPC_STR: nd->params.str = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_AGI: nd->params.agi = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_VIT: nd->params.vit = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_INT: nd->params.int_ = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_DEX: nd->params.dex = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_LUK: nd->params.luk = script_setunitdata_helper<unsigned short>(value); status_calc_misc(bl, &nd->status, nd->level); break;
			case UNPC_PLUSALLSTAT: nd->stat_point = script_setunitdata_helper<unsigned int>(value); break;
			case UNPC_ATKRANGE: nd->status.rhw.range = script_setunitdata_helper<unsigned short>(value); break;
			case UNPC_ATKMIN: nd->status.rhw.atk = script_setunitdata_helper<unsigned short>(value); break;
			case UNPC_ATKMAX: nd->status.rhw.atk2 = script_setunitdata_helper<unsigned short>(value); break;
			case UNPC_MATKMIN: nd->status.matk_min = script_setunitdata_helper<unsigned short>(value); break;
			case UNPC_MATKMAX: nd->status.matk_max = script_setunitdata_helper<unsigned short>(value); break;
			case UNPC_DEF: nd->status.def = script_setunitdata_helper<defType>(value); break;
			case UNPC_MDEF: nd->status.mdef = script_setunitdata_helper<defType>(value); break;
			case UNPC_HIT: nd->status.hit = script_setunitdata_helper<short>(value); break;
			case UNPC_FLEE: nd->status.flee = script_setunitdata_helper<short>(value); break;
			case UNPC_PDODGE: nd->status.flee2 = script_setunitdata_helper<short>(value); break;
			case UNPC_CRIT: nd->status.cri = script_setunitdata_helper<short>(value); break;
			case UNPC_RACE: nd->status.race = script_setunitdata_helper<unsigned char>(value); break;
			case UNPC_ELETYPE: nd->status.def_ele = script_setunitdata_helper<unsigned char>(value); break;
			case UNPC_ELELEVEL: nd->status.ele_lv = script_setunitdata_helper<unsigned char>(value); break;
			...
			case UNPC_HEADBOTTOM: clif_changelook(bl, LOOK_HEAD_BOTTOM, script_setunitdata_helper<unsigned short>(value)); break;
			case UNPC_HEADMIDDLE: clif_changelook(bl, LOOK_HEAD_MID, script_setunitdata_helper<unsigned short>(value)); break;
			case UNPC_HEADTOP: clif_changelook(bl, LOOK_HEAD_TOP, script_setunitdata_helper<unsigned short>(value)); break;
			case UNPC_CLOTHCOLOR: clif_changelook(bl, LOOK_CLOTHES_COLOR, script_setunitdata_helper<unsigned short>(value)); break;
			case UNPC_SHIELD: clif_changelook(bl, LOOK_SHIELD, script_setunitdata_helper<unsigned short>(value)); break;
