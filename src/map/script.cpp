...
BUILDIN_FUNC(getfreecell)
{
	...
	set_reg(st, sd, reference_getuid(data_x), name_x, (void*)__64BPRTSIZE((int)x), data_x->ref);
	set_reg(st, sd, reference_getuid(data_y), name_y, (void*)__64BPRTSIZE((int)y), data_y->ref);
