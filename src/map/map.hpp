...
enum _sp {
	...
	SP_NON_CRIT_ATK_RATE, SP_BASETHIRD, SP_BASEFOURTH, //2108 - 2110
	SP_PRIMARY_THIRD, SP_PRIMARY_FOURTH, SP_UPPER_EXPANDED_FIRST, SP_UPPER_EXPANDED_SECOND, SP_RENEWAL_JOB, SP_TRAIT_JOB// 2111 - 2116
};
