...
struct mob_data {
	...
	struct s_dmglog {
		int32 id; // char id
		uint32 dmg;
		uint32 dmg_tanked; // Damage tanked from normal attacks of the monster, MVP is the player with highest
						   // dmg+dmg_tanked
...
struct mob_data *mob_once_spawn_sub(struct block_list *bl,
									int16 m,
									int16 x,
									int16 y,
									const char *mobname,
...
int32 mob_once_spawn(map_session_data *sd,
					 int16 m,
					 int16 x,
					 int16 y,
					 const char *mobname,
...
int32 mob_once_spawn_area(map_session_data *sd,
						  int16 m,
						  int16 x0,
						  int16 y0,
						  int16 x1,
...
int32 mob_spawn_guardian(const char *mapname,
						 int16 x,
						 int16 y,
						 const char *mobname,
						 int32 mob_id,
						 const char *event,
						 int32 guardian,
						 bool has_index); // Spawning Guardians [Valaris]
int32 mob_spawn_bg(
	const char *mapname, int16 x, int16 y, const char *mobname, int32 mob_id, const char *event, uint32 bg_id);
...
int32 mob_clone_spawn(map_session_data *sd,
					  int16 m,
					  int16 x,
					  int16 y,
					  const char *event,
...
int32 mob_getdroprate(struct block_list *src,
