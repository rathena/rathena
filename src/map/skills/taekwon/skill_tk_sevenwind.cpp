...
SkillTK_SEVENWIND::SkillTK_SEVENWIND() : SkillImpl(TK_SEVENWIND) {
}

void SkillTK_SEVENWIND::castendNoDamageId(struct block_list *src, struct block_list *bl, uint16 skill_lv, t_tick tick, int32 flag) const {
