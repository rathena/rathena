...
SkillTK_READYCOUNTER::SkillTK_READYCOUNTER() : SkillImpl(TK_READYCOUNTER) {
}

void SkillTK_READYCOUNTER::castendNoDamageId(struct block_list *src, struct block_list *bl, uint16 skill_lv, t_tick tick, int32 flag) const {
