...
SkillApexPhase::SkillApexPhase() : SkillImpl(AT_APEX_PHASE) {
}

void SkillApexPhase::castendNoDamageId(block_list* src, block_list* target, uint16 skill_lv, t_tick tick, int32& flag) const {
	int32 reduce = 0;
