...
SkillTransformationBeast::SkillTransformationBeast() : SkillImpl(DR_WEREWOLF) {
}

void SkillTransformationBeast::castendNoDamageId(block_list *src, block_list *target, uint16 skill_lv, t_tick tick, int32 &flag) const {
