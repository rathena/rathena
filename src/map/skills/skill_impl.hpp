...
public:
	...
	/**
	 * Apply additional effects on target after damage - called from skill_additional_effect
	 */
	...
	/**
	 * Apply additional effects on src after damage - called from skill_counter_additional_effect
	 */
