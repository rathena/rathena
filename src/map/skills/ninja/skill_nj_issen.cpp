...
SkillNJ_ISSEN::SkillNJ_ISSEN() : SkillImpl(NJ_ISSEN) {
}

void SkillNJ_ISSEN::castendDamageId(block_list* src, block_list* target, uint16 skill_lv, t_tick tick, int32 flag) const {
#ifdef RENEWAL
	{
		int16 x, y;
