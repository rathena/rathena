...
int intif_create_pet(uint32 account_id, uint32 char_id, short pet_type, short pet_lv, nameid_t pet_egg_id, nameid_t pet_equip, short intimate, short hungry, char rename_flag, char incubate, char *pet_name);
